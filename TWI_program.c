...
void TWI_voidInitMaster(u8 Copy_u8Address)
{
	...
	/*1- Set TWBR to 2 or 12 if 16Mhz*/
	TWBR = 2;
	...
	if((Copy_u8Address != 0)&&(Copy_u8Address<128))
	{
...
TWI_ErrStatus TWI_MasterReadDataByte_withAck(u8* Copy_pu8DataByte)
{
	TWI_ErrStatus Local_Error= NoError;
...
TWI_ErrStatus TWI_MasterReadDataByte_withNAck(u8* Copy_pu8DataByte)
{
	TWI_ErrStatus Local_Error= NoError;
	...
	/*Check the operation status*/
	if((TWSR & 0xF8) !=  TWI_MASTER_DATA_RECIEVE_NACK)
	{
		Local_Error = MasterReadByteErr;
	}
	else
